...
using BlazorTemplate.UI.Shared.Locales.EmbeddedJson;
using BlazorTemplate.UI.Shared.Locales.Services;

namespace BlazorTemplate.UI.Shared.Locales.Extensions;
