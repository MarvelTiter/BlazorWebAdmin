    ...
    IAppStore app) : IUIService
{
    ...
    public RenderFragment UIFrameworkJs()
    {
        return b =>
        {
            ...
            b.Component<VScript>().SetComponent(c => c.Src, "_content/BlazorTemplate.UI.AntBlazor/ant-color.js").Build();
            b.Component<VScript>().SetComponent(c => c.Src, "_content/BlazorTemplate.UI.AntBlazor/ant-style.js").Build();
            //b.Component<VScript>().SetComponent(c => c.Src, "_content/BlazorTemplate.UI.AntBlazor/less.min.js").Build();
        };
    }
