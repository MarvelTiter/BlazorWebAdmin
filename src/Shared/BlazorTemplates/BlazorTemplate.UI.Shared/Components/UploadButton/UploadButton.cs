...
public class UploadButton : AppComponentBase
{
    ...
    protected override void BuildRenderTree(RenderTreeBuilder builder)
    {
        ...
        //    @UI.BuildFakeButton(new() { ButtonType = BlazorTemplate.Constraints.UI.ButtonType.Primary, Text = "导入Excel" })
        //</label>
        ...
        builder.AddContent(2, child =>
        {
            ...
            child.AddContent(5, UI.BuildFakeButton(new() { ButtonType = BlazorTemplate.Constraints.UI.ButtonType.Primary, Text = Text }));
        });
